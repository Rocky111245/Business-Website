        ...
        <div className="services__container">
            ...
            <div className="services__features-container">
                <section className="services__feature">
                    <MdLocalHospital className="services__icon" color="#4caf50" />
                ...
                <section className="services__feature">
    <MdEngineering className="services__icon"  color="#673ab7" />
    <div className="services__content">
        ...
        <p>Our team, with over 20 years of medical equipment expertise, swiftly addresses any challenge with precision.</p>
                ...
                <section className="services__feature">
                    <MdVerifiedUser className="services__icon" color="#2196f3" />
                    <div className="services__content">
                ...
                <section className="services__feature">
                    <MdBuild className="services__icon" color="#ff9800" />
                    <div className="services__content">
                ...
                <section className="services__feature">
                    <MdPublic className="services__icon" color="#9c27b0" />
                    <div className="services__content">
                ...
                {/* New Sections */}
                <section className="services__feature">
                    <MdLocalShipping className="services__icon" color="#795548" />
                    <div className="services__content">
                ...
                <section className="services__feature">
                    <MdForum className="services__icon"color="#03a9f4" />
                    <div className="services__content">
                ...
                <section className="services__feature">
                    <MdLightbulbOutline className="services__icon" color="#4caf50" />
                    <div className="services__content">
